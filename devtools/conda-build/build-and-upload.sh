...
#     5. pyside6-addons-uibcdf      <-- this repo (needs all of the above built first)
#
# Options:
...
PKG_NAME="pyside6-addons-uibcdf"
CHANNEL="uibcdf"
...
# (If a prerequisite uibcdf package is not yet built into the local channel, conda
#  build stops here with a clear 'nothing provides ...' error — build the family in
#  order first: shiboken6 -> essentials -> positioning -> webengine -> addons.)
