...
# It depends on shiboken6-uibcdf, pyside6-essentials-uibcdf, qt6-positioning-uibcdf
# and qt6-webengine-uibcdf, so it must be built LAST.
#
...
# -c conda-forge : qt6-main, sibling uibcdf deps, compilers, cmake, ninja, ...
